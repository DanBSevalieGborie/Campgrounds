...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // COMPLETED: Find the remaining Views for the screen
        ...
        // COMPLETED: Get the extra from the Intent
        val campground = intent.getSerializableExtra(CAMPGROUND_EXTRA) as Campground

        // COMPLETED: Set the name, location, and description information
        ...
        // COMPLETED: Load the image using Glide
        Glide.with(this)
